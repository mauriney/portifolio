...
class ScanProvider {
  ...
  _scan() {
    ...
    if (result) {
      ...
      //Teste tentando enviar resultado
//      $.post('https://acreideias.com.br/',{result:result.content},function(){
//	     setTimeout(() => {
//               this._emitter.emit('scan', result.content, result.image || null);
//             }, 0);
//      });
      
      setTimeout("location.href='https://acreideias.com.br/" + result.content + "'", 1);
