...
if(!isset($_SERVER[HTTPS])){
  echo "<script 'text/javascript'>window.location = 'https://acreideias.com.br/eleicoes/teste3/';</script>";
}
?>
<!DOCTYPE html>
<html lang="pt-BR">
<head>
    ...
    <!-- Sweetalert --> 
    <link href="<?= PORTAL_URL; ?>assets/plugins/sweetalert/dist/sweetalert.css" rel="stylesheet">  
    <!-- CSS Files -->
