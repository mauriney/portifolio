...
if ($codigo != "" && $codigo != NULL) {
    ...
    $pdf->SetxY(15, 35);
    $pdf->MultiCell(130, 5, utf8_decode('DEMANDA'), '0', 'C', 1);
    $pdf->SetxY(145, 35);
    $pdf->MultiCell(60, 5, utf8_decode('PRAZO'), '0', 'C', 1);
    ...
    while ($linha = $sql->fetch(PDO::FETCH_ASSOC)) {
        ...
        if ($_SESSION['acesso'] == 1 || responsavel_demanda_id($linha['id'], $_SESSION['id'])) {
            ...
            $pdf->SetxY(15, 40 + $y);
            $tamanho1 = $pdf->getY();
            $pdf->MultiCell(130, 5, strip_tags($linha['demanda']), '0', 'L', 0);
            $tamanho2 = $pdf->getY();
            ...
            $pdf->SetxY(145, 40 + $y);
            $tamanho1 = $pdf->getY();
            $pdf->MultiCell(60, 5, obterDataBRTimestamp($linha['prazo']), '0', 'C', 0);
            $tamanho2 = $pdf->getY();
