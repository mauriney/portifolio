...
(function (root, factory) {
    ...
    Imp.prototype = {
        ...
        open: function (message, options) {
            ...
            msgbox += '<div class="' + opts.prefix + ' ' + opts.classes.prompt + '"><div class="circulo"></div>' +
        ...
        addState: function (statename, stateobj, afterState) {
            ...
            for (i = 0, l = buttons.length; i < l; i++) {
                ...
                state += '<div class="botoes"><button class="' + opts.classes.button + ' bt_' + v.title.replace(/[^a-z0-9]+/gi, '') + ' ' + opts.prefix + 'button ' + defbtn;

                if (typeof v.classes !== "undefined") {
                    state += ' ' + ($.isArray(v.classes) ? v.classes.join(' ') : v.classes) + ' ';
                }

                state += '" name="' + opts.prefix + '_' + statename + '_button' + v.title.replace(/[^a-z0-9]+/gi, '') + '" value="' + v.value + '">' + v.title + '</button></div>';
            }
