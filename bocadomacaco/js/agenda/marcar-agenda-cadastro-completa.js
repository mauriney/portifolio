 ...
 */
$("#titulo1").html("Marcar Agenda Completa");
    ...
    $('#form_marcar_agenda').submit(function () {
        ...
        if (form_valido) {
            projetouniversal.util.getjson({
                url: PORTAL_URL + "controller/agenda/salvar_marcar_agenda_completa.php",
                type: "POST",
...
function desmarcar_basico() {
    if (!$("#intermediario").attr("checked")) {
        $("#basico").attr("checked", false);
    }
}