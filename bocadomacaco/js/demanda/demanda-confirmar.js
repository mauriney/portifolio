/*
 * SCRIPT DO FORMULÁRIO DE CONFIRMAÇÃO DE DEMANDA
 */

$("#titulo1").html("Confirmação de Demanda");
...
$(document).ready(function () {
    ...
    $('#form_demanda').submit(function () {
        ...
        if (form_valido) {
            projetouniversal.util.getjson({
                url: PORTAL_URL + "controller/demanda/confirmar_demanda.php",
                type: "POST",
    ...
    function onSuccessSend(obj) {
        if (obj.msg == 'success') {
            postToURL(PORTAL_URL + 'demanda-painel-confirmar.php', {mensagem: obj.retorno});
