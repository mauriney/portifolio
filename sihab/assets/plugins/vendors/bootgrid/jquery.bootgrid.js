...
;(function ($, window, undefined)
{
    ...
    */
    ...
    Grid.defaults = {
        ...
        labels: {
            all: "Todos",
            infos: "Visualizando {{ctx.start}} até {{ctx.end}} de {{ctx.total}} entradas",
            loading: "Carregando...",
        ...
        templates: {
            ...
            header: "<div id=\"{{ctx.id}}\" class=\"{{css.header}}\"><div class=\"row\"><div class=\"col-sm-12\"><p class=\"{{css.actions}}\"></p></div></div></div>",
