...
<html>
  ...
  <body class="applicant-data">
    <header>
      ...
      <a href="#" class="print btn palette-Teal-600 bg btn-float waves-effect"><i class="zmdi zmdi-print zmdi-hc-fw"></i></a>
      <a href="#" class="logout btn palette-Pink-A400 bg btn-float waves-effect"><i class="zmdi zmdi-power zmdi-hc-fw"></i></a>
    </header>
    <section class="content">

      <?php include_once "visualiza-impressao.php"; ?>
