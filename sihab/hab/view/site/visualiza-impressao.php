...
// SITUAÇÃO------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
$result = $db->prepare("SELECT data_cadastro, hab_tipo_situacao_id
                        FROM hab_candidato_situacao
			WHERE id IN (SELECT MAX(id) FROM hab_candidato_situacao WHERE hab_candidato_id = ? GROUP BY hab_candidato_id)
          ...
          <tr>
                  ...
                  <div class="card-body card-padding-sm">
                    <div class="row">
                      <div class="col-md-4 col-md-offset-4">
                        <div class="validade">
                          <small>CADASTRO VÁLIDO POR</small>
                          <span><?= ctexto(diff_data_dias($dados_situacao['data_cadastro'], Date("Y-m-d")), "mai"); ?></span>
                        </div>
                      </div>
                    </div>
            ...
            <!--                <input value="option1" type="checkbox">
             ...
             WHERE hpr.hab_pessoa_id = ?");
                    ...
                    <div class="content">
                      <div class="row">
                        <div class="col-md-12 col-xs-12">Não existe Cônjuge para esse candidato</div>
                      </div>
                    </div>
                    <?php
                  }
