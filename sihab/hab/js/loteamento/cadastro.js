/*---------------------------------------------------------------------------------------------------------
 DATA: 20/02/2016 ÀS 16:54
 NOME: JS DA CLASSE CADASTRO DE LOTEAMENTO
 DESENVOLVEDOR: MAURINEY R. DA COSTA
 ---------------------------------------------------------------------------------------------------------*/
$(document).ready(function () {

//Jogando a busca para a lista de ação
  $("form#form_busca").attr('action', PORTAL_URL + "sistema/loteamento/lista");
...
//CADASTRO DE AÇÃO
  $('form#form_acao').submit(function () {
    ...
    if (recuperar_validator()) {
      $.ajax({
        type: "POST",
        url: PORTAL_URL + 'hab/dao/loteamento/cadastro',
        ...
        success: function (obj) {
          ...
          if (obj.msg == 'success') {
            ...
            swal({
              title: "Formulário de Loteamento",
              text: obj.retorno,
              type: "success",
