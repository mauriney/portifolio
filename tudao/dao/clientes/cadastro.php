...
try {
    ...
    if (is_numeric($id_pessoa) && $id_pessoa != @$id) {
        $error = true;
        $mensagem .= "- O nome do cliente informado já existe no sistema.";
        $msg['tipo'] = "nome";
    }
    ...
    if (is_numeric($id_email) && $id_email != @$id) {
        $error = true;
        $mensagem .= "\n- O e-mail do cliente informado já existe no sistema.";
        $msg['tipo'] = "email";
    }
    ...
    if (!valida_cpf($cpf)) {
        $error = true;
        $mensagem .= "\n- O CPF do cliente informado é inválido.";
        $msg['tipo'] = "cpf";
    } else {
        ...
        if (is_numeric($id_cpf) && $id_cpf != @$id) {
            $error = true;
            $mensagem .= "\n- O CPF do cliente informado já existe no sistema.";
            $msg['tipo'] = "cpf";
        }
    }
