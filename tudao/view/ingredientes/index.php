            ...
            <div class="box box-danger">
                ...
                <div class="box-body">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php
                            $sql = $db->prepare("SELECT id, nome, add_valor, add_pontos, status
                             FROM ingredientes
                             ORDER BY nome ASC");
                            $sql->execute();
                            while ($linha = $sql->fetch(PDO::FETCH_ASSOC)) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo "R$ " . fdec($linha['add_valor']); ?></td>
                                    <td><?php echo $linha['add_pontos']; ?></td>
                                    <td align="center">
                                        <?php
                                        if ($linha['status'] == 1) {
                                            ?>
                                            <a title="Desativar Ingrediente" href="#" class="label label-success" onclick="remover(<?php echo $linha['id'] ?>)">
                                                <i class="fa fa-unlock"></i>
                                            </a>
                                            <?php
                                        } else {
                                            ?>
                                            <a title="Ativar Ingrediente" href="#" class="label label-danger" onclick="ativar(<?php echo $linha['id'] ?>)">
                                    ...
                                    <td align="center">
                                        <a href="cadastro.php?id=<?php echo $linha['id']; ?>" class="label label-warning"><i class="fa fa-pencil text-black"></i></a>
                                    </td>
                                </tr>
                                <?php
                            }
...
<!-- JS DA LISTA -->
<script type="text/javascript" src="<?= PORTAL_URL; ?>scripts/ingredientes/index.js"></script>
