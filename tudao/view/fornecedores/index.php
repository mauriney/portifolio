                            ...
                            while ($linha = $sql->fetch(PDO::FETCH_ASSOC)) {
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        ...
                                        if ($linha['status'] == 1) {
                                            ?>
                                            <a title="Desativar Fornecedor" href="#" class="label label-success" onclick="remover(<?php echo $linha['id'] ?>)">
                                                <i class="fa fa-unlock"></i>
                                            </a>
                                            <?php
                                        } else {
                                            ?>
                                            <a title="Ativar Fornecedor" href="#" class="label label-danger" onclick="ativar(<?php echo $linha['id'] ?>)">
...
<!-- JS DA LISTA -->
<script type="text/javascript" src="<?= PORTAL_URL; ?>scripts/fornecedores/index.js"></script>
