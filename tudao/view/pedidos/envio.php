        ...
        <section class="content">
            ...
            <div class="box box-danger">
                <div class="box-header">
                    <h3 class="box-title">Pronto para Envio</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                        ...
                        <tbody>
                            ...
                            while ($linha = $sql->fetch(PDO::FETCH_ASSOC)) {
                              ...
                              <tr>
                                  ...
                                  <td><?php echo $linha['responsavel'] == "" || $linha['responsavel'] == NULL ? "Sem responsável" : $linha['responsavel']; ?></td>
                                  <td align="center">
                                      <a title="Desativar Pedido" href="#" class="label label-success" onclick="remover(<?php echo $linha['id'] ?>)">
                                          <i class="fa fa-unlock"></i>
                                      </a>
                                      &nbsp;
                                      <a href="visualizar.php?id=<?php echo $linha['id']; ?>" class="label label-warning">  <i class="fa fa-search text-black"></i></a>
                                  </td>
                              </tr>
                              <?php
                            }
...
<!-- JS DA LISTA -->
<script type="text/javascript" src="<?= PORTAL_URL; ?>scripts/pedidos/envio.js"></script>
