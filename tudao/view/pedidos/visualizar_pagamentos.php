...
if (is_numeric($id)) {//VERIFICA SE O ID PASSADO POR PARÂMETRO É UM NÚMERO
  $sql = $db->prepare("SELECT p.status, pes.nome AS funcionario, fp.id AS forma_pagamento_id, fp.nome AS forma_pagamento, p.valor_pagamento as pago, p.valor_troco as troco, c.codigo AS cupom, p.id, p.mesa, b.nome AS bairro, p.endereco, p.complemento, p.numero, p.contato
                             FROM pedidos p
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="box box-danger">
                <form id="form_pagamento" name="form_pagamento" action="#" method="post">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row cart-total">
                            <div class="col-md-4">
                                <div id="div_funcionario" class="callout callout-info">
                                    <h4>Funcionário</h4>
                                    <p><?php echo $reg['funcionario']; ?></p>
                                </div>
                            </div>
                        </div>
                        <br/>
...
<!-- JS DO REGISTER -->
<script type="text/javascript" src="<?= PORTAL_URL; ?>scripts/pedidos/visualizar_pagamentos.js"></script>