        ...
        <section class="content">
            ...
            <div class="box box-danger">
                <div class="box-header">
                    <h3 class="box-title">Pedidos Cancelados</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                        ...
                        <tbody>
                            ...
                            while ($linha = $sql->fetch(PDO::FETCH_ASSOC)) {
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        <a title="Ativar Pedido" href="#" class="label label-danger" onclick="ativar(<?php echo $linha['id'] ?>)">
                                            <i class="fa fa-lock"></i>
                                        </a>
                                        &nbsp;
                                        <a href="visualizar_cancelados.php?id=<?php echo $linha['id']; ?>" class="label label-warning">  <i class="fa fa-search text-black"></i></a>
                                    </td>
                                </tr>
                                <?php
                            }
...
<!-- JS DA LISTA -->
<script type="text/javascript" src="<?= PORTAL_URL; ?>scripts/pedidos/cancelados.js"></script>
