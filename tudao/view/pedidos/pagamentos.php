        ...
        <section class="content">
            ...
            <div class="box box-danger">
                <div class="box-header">
                    <h3 class="box-title">Enviado para Entrega</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php
                            $sql = $db->prepare("SELECT fp.id AS forma_pagamento_id, p.vlr_total_pontos, pf.nome AS responsavel, cp.nome AS cliente, p.cadastro, p.atualizacao, p.id, p.valor_pagamento, p.valor_troco, fp.nome AS forma_pagamento, p.status
                             FROM pedidos p
                            ...
                            while ($linha = $sql->fetch(PDO::FETCH_ASSOC)) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $linha['responsavel'] == "" || $linha['responsavel'] == NULL ? "" : $linha['responsavel']; ?></td>
                                    <td align="center">
                                        <a title="Desativar Pedido" href="#" class="label label-success" onclick="remover(<?php echo $linha['id'] ?>)">
                                            <i class="fa fa-unlock"></i>
                                        </a>
                                        &nbsp;
                                        <a href="visualizar_pagamentos.php?id=<?php echo $linha['id']; ?>" class="label label-warning">  <i class="fa fa-search text-black"></i></a>
                                    </td>
                                </tr>
                                <?php
                            }
...
<!-- JS DA LISTA -->
<script type="text/javascript" src="<?= PORTAL_URL; ?>scripts/pedidos/pagamentos.js"></script>
