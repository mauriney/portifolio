...
if (is_numeric($id)) {//VERIFICA SE O ID PASSADO POR PARÂMETRO É UM NÚMERO
    $sql = $db->prepare("SELECT fp.id AS forma_pagamento_id, fp.nome AS forma_pagamento, p.valor_pagamento as pago, p.valor_troco as troco, c.codigo AS cupom, p.id, p.mesa, b.nome AS bairro, p.endereco, p.complemento, p.numero, p.contato
                             FROM pedidos p
        ...
        <section class="content">
            ...
            <div class="box box-danger">
                <div class="box-header">
                    <h3 class="box-title">Visualização do Pedido</h3>
                </div><!-- /.box-header -->

                <div class="panel-heading">
                    <h3 class="panel-title">Modo de pagamento?</h3>


                    <div class="row">
                        <div class="col-md-3">
                            <div id="div_forma_pagamento" class="form-group">
                                <?php echo $reg['forma_pagamento']; ?>
                            </div>
                        </div>

                        <div <?php echo $reg['forma_pagamento_id'] == 1 ? '' : 'style="display: none"'; ?> class="col-md-3">
                            <p class="help-block">Valor Pago</p>
                            <div id="div_valor_pagar" class="form-group">
                                <?php echo fdec($reg['pago']); ?>    
                            </div>
                        </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td id="total_pontos" class="text-right">
                                        <text id="total_pontos"><?php echo $subpontosgeral; ?></text> pontos
                                    </td>
                                </tr>
                            </tbody>
                        </table>
