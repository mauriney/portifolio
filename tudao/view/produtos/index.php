            ...
            <div class="box box-danger">
                ...
                <div class="box-body">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php
                            $sql = $db->prepare("SELECT p.id, p.nome, p.valor, p.status, c.nome AS categoria
                             FROM produtos p
                            ...
                            while ($linha = $sql->fetch(PDO::FETCH_ASSOC)) {
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        ...
                                        if ($linha['status'] == 1) {
                                            ?>
                                            <a title="Desativar Produto" href="#" class="label label-success" onclick="remover(<?php echo $linha['id'] ?>)">
                                                <i class="fa fa-unlock"></i>
                                            </a>
                                            <?php
                                        } else {
                                            ?>
                                            <a title="Ativar Produto" href="#" class="label label-danger" onclick="ativar(<?php echo $linha['id'] ?>)">
...
<!-- JS DA LISTA -->
<script type="text/javascript" src="<?= PORTAL_URL; ?>scripts/produtos/index.js"></script>
