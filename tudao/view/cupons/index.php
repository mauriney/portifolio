            ...
            <div class="box box-danger">
                ...
                <div class="box-body">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php
                            $sql = $db->prepare("SELECT id, codigo, valor, pontos, status
                             FROM cupons
                             ORDER BY id ASC");
                            $sql->execute();
                            while ($linha = $sql->fetch(PDO::FETCH_ASSOC)) {
                                ...
                                <tr>
                                    ...
                                    <td>R$ <?php echo fdec($linha['valor']); ?></td>
                                    <td><?php echo $linha['pontos']; ?></td>
                                    <td align="center">
                                        <?php
                                        if ($linha['status'] == 1) {
                                            ?>
                                            <a title="Desativar Cupom" href="#" class="label label-success" onclick="remover(<?php echo $linha['id'] ?>)">
                                                <i class="fa fa-unlock"></i>
                                            </a>
                                            <?php
                                        } else {
                                            ?>
                                            <a title="Ativar Cupom" href="#" class="label label-danger" onclick="ativar(<?php echo $linha['id'] ?>)">
...
<!-- JS DA LISTA -->
<script type="text/javascript" src="<?= PORTAL_URL; ?>scripts/cupons/index.js"></script>
