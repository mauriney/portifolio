    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo PORTAL_URL; ?>view/funcionarios/index.php"> <b>Funcionários</b></a></li>
...
<!-- JS DO REGISTER -->
<script type="text/javascript" src="<?= PORTAL_URL; ?>scripts/funcionarios/cadastro.js"></script>